...
train_delta_path = f"{path}/train.delta"
test_delta_path = f"{path}/test.delta"
...
train_delta_new = train_new
test_delta_new = test_new
...
# TODO
'''
train_new.write.model('overwrite').option('mergeSchema','true').save(train_delta_path)
test_new.write.model('overwrite').option('mergeSchema','true').save(test_delta_path)
'''
