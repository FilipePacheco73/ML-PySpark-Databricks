...
log_test_df = test_df.withColumn('loggripce', log('price'))

r_formula = RFormula(formula='logprice ~ . - price', featuresCol='features', labelCol='price', handleInvalid='skip') # Look at handleInvalid
