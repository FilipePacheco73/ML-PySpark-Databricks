...
file_path = file_path = "xxxxxxxxxxxxxx"
df = spark.read.format("delta").load(file_path).toPandas()[['host_total_listings_count','latitude','longitude','price']].dropna()
...
model_name = f"training_sklearn_lr"
model_name
