...
file_path = "/mnt/edl/raw/scf_cq_hub/imputed_results/"
#dbutils.fs.mkdirs("/mnt/edl/raw/scf_cq_hub/delta_file")
delta_path = "/mnt/edl/raw/scf_cq_hub/delta_file/"
...
# MAGIC %sql
# MAGIC DESCRIBE HISTORY delta. `/mnt/edl/raw/scf_cq_hub/delta_file/`
...
timestamp = spark.sql(f"DESCRIBE HISTORY delta.`/mnt/edl/raw/scf_cq_hub/delta_file/`").orderBy("version").first().timestamp
